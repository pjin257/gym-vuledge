...
import numpy as np
from gym_vuledge.envs.evalnet4d import ROADNET
import logging

class Eval4dEnv(gym.Env):
    """A vulnerable edge detection environment for OpenAI gym"""

    def __init__(self):
        super(Eval4dEnv, self).__init__()
    ...
    def get_reward(self, is_dup_action):
        ...
        baselines = [873, 919, 943, 103] # averaged over 100 simulations

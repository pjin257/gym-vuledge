...
import numpy as np
from gym_vuledge.envs.reversenet4d import ROADNET
import logging

class Reverse4dEnv(gym.Env):
    """A vulnerable edge detection environment for OpenAI gym"""

    def __init__(self):
        super(Reverse4dEnv, self).__init__()
    ...
    def get_reward(self, is_dup_action):
        ...
        baselines = [933, 982, 1031, 317] # averaged over 100 simulations

...
import numpy as np
from gym_vuledge.envs.roadnet2d import ROADNET
import logging

class VulEdge2dEnv(gym.Env):
    """A vulnerable edge detection environment for OpenAI gym"""

    def __init__(self):
        super(VulEdge2dEnv, self).__init__()
    ...
    def get_reward(self, is_dup_action):
        ...
        baselines = [873, 103] # averaged over 100 simulations

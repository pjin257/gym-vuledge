...
import numpy as np
from gym_vuledge.envs.reversenet2d import ROADNET
import logging

class Reverse2dEnv(gym.Env):
    """A vulnerable edge detection environment for OpenAI gym"""

    def __init__(self):
        super(Reverse2dEnv, self).__init__()
    ...
    def get_reward(self, is_dup_action):
        ...
        baselines = [933, 317] # averaged over 100 simulations

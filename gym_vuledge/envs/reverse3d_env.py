...
import numpy as np
from gym_vuledge.envs.reversenet3d import ROADNET
import logging

class Reverse3dEnv(gym.Env):
    """A vulnerable edge detection environment for OpenAI gym"""

    def __init__(self):
        super(Reverse3dEnv, self).__init__()
    ...
    def get_reward(self, is_dup_action):
        ...
        baselines = [933, 982, 317] # averaged over 100 simulations
